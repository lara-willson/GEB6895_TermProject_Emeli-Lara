...
hotel_review$Pool <- as.numeric(ifelse(hotel_review$Pool == 'YES', 1, 0))
hotel_review$Gym <- as.numeric(ifelse(hotel_review$Gym == 'YES', 1, 0))
hotel_review$Tennis.court <- as.numeric(ifelse(hotel_review$Tennis.court == 'YES', 1, 0))
hotel_review$Spa <- as.numeric(ifelse(hotel_review$Spa == 'YES', 1, 0))
hotel_review$Casino <- as.numeric(ifelse(hotel_review$Casino == 'YES', 1, 0))
hotel_review$Free.internet <- as.numeric(ifelse(hotel_review$Free.internet == 'YES', 1, 0))
...
cor(hotel_review[c(2,3,4,5,8,9,10,11,12,13,15,16,18)])
